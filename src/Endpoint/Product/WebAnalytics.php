...
/**
 * SDK API for working with Web Analytics products.
 *
 * @title Web Analytics Product API
 * @copyright Dreamscape Networks International Pte Ltd https://www.dreamscapenetworks.com
 */
class WebAnalytics extends AbstractEndpoint
{
    /**
     * Returns the list of existing Web Analytics products.
     *
     * @param Filter\Product\WebAnalytics\GetAll|null $filters
     *
     * @return DataObject\Product\WebAnalytics\Existing[]|DataObject\Collection
     ...
     * }
     */
    public function getAll(Filter\Product\WebAnalytics\GetAll $filters = null): DataObject\Collection
    {
        return DataObject\Helper::convertResponseToDataObjectCollection(
            $this->sendGetRequest('products/web-analytics', $filters ? $filters->toRequestArray() : []),
            DataObject\Product\WebAnalytics\Existing::class
        );
    }
     ...
     *
     * @return DataObject\Product\WebAnalytics\Existing
     * @throws AuthenticationException
     ...
     * }
     */
    public function getDetails(int $product_id): DataObject\Product\WebAnalytics\Existing
    {
        if ($product_id < 1) {
        ...
        return DataObject\Helper::convertResponseToDataObject(
            $this->sendGetRequest('products/web-analytics/' . $product_id),
            DataObject\Product\WebAnalytics\Existing::class
        );
    }
     ...
     *
     * @param int $product_id
     * @param DataObject\Product\WebAnalytics\LoginLink\Create|null $data_object
     *
     * @return DataObject\Product\WebAnalytics\LoginLink\Existing
     * @example
     * use Dreamscape\ResellerApiSdk\Api;
     * use Dreamscape\ResellerApiSdk\Authenticator\ApiKey;
     * use Dreamscape\ResellerApiSdk\Http\Adapter\Curl;
    ...
    public function createLoginLink(
        int $product_id,
        DataObject\Product\WebAnalytics\LoginLink\Create $data_object = null
        ...
        return DataObject\Helper::convertResponseToDataObject(
            $this->sendPostRequest(
                'products/web-analytics/' . $product_id . '/login-link',
                $data_object ? $data_object->toRequestArray() : []
            ),
            DataObject\Product\WebAnalytics\LoginLink\Existing::class
        );
    }
     ...
     *
     * @param DataObject\Product\WebAnalytics\Register $data_object
     *
     * @return DataObject\Product\WebAnalytics\Existing
     * @throws AuthenticationException
     * @throws BadRequestException
    ...
    public function register(
        DataObject\Product\WebAnalytics\Register $data_object
    ): DataObject\Product\WebAnalytics\Existing {
        return DataObject\Helper::convertResponseToDataObject(
            $this->sendPostRequest('products/web-analytics', $data_object->toRequestArray()),
            DataObject\Product\WebAnalytics\Existing::class
        );
    }
     ...
     *
     * @param int $product_id
     * @param DataObject\Product\WebAnalytics\Renew|null $data_object
     *
     * @return DataObject\Product\WebAnalytics\Existing
     * @throws AuthenticationException
     * @throws NotFoundException
    ...
    public function renew(
        int $product_id,
        DataObject\Product\WebAnalytics\Renew $data_object = null
    ): DataObject\Product\WebAnalytics\Existing {
        if ($product_id < 1) {
            throw new InvalidArgumentException('The argument $product_id must be positive integer');
        }
        ...
        return DataObject\Helper::convertResponseToDataObject(
            $this->sendPostRequest(
                'products/web-analytics/' . $product_id . '/renewal',
                $data_object ? $data_object->toRequestArray() : []
            ),
            DataObject\Product\WebAnalytics\Existing::class
        );
    ...
    public function terminate(int $product_id): bool
    {
        ...
        return $this->sendDeleteRequest('products/web-analytics/' . $product_id);
    }
}
