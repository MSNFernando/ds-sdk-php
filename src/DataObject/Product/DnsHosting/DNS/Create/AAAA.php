...
namespace Dreamscape\ResellerApiSdk\DataObject\Product\DnsHosting\DNS\Create;
...
class AAAA extends AbstractRecord
{
    ...
    {
        return PredefinedValue\Domain\DNS::AAAA;
    }
                ...
                Property::build('content')
                    ...
                    ->rules(
                        RuleSet::build()->addRule(Rule::required())
                            ...
                            ->addRule(Rule::ipAddress(Rule\IpAddress::TYPE_IPV6))
                    )
            );
    }
}
